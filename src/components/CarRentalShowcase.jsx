...
// 4. Miami SUV Rentals (img41 - img48)
const cars4 = [
...
// New Section: Affordable car rental in San Francisco (img49 - img56)
const cars5 = [
    {
        id: 49,
        ...
        img: '/img49.png',
        badge: 'HYBRID',
        desc: 'Efficient hybrid SUV with excellent fuel economy and reliability.',
        tag: 'Hybrid SUV'
    },
    {
        id: 50,
        ...
        img: '/img50.png',
        badge: 'ELECTRIC',
        desc: 'Modern electric SUV with impressive range and advanced features.',
        tag: 'Electric SUV'
    },
    {
        id: 51,
        ...
        img: '/img51.png',
        badge: 'POPULAR',
        desc: 'Spacious and comfortable compact SUV with premium feel.',
        tag: 'Compact SUV'
    },
    {
        id: 52,
        ...
        img: '/img52.png',
        badge: 'AFFORDABLE',
        desc: 'Reliable compact SUV offering great value for money.',
        tag: 'Compact SUV'
    },
    {
        id: 53,
        ...
        img: '/img53.png',
        badge: 'PREMIUM',
        desc: 'Luxury electric SUV with falcon wing doors and advanced technology.',
        tag: 'Electric SUV'
    },
    {
        id: 54,
        ...
        img: '/img54.png',
        badge: 'BEST DEAL',
        desc: 'Reliable and fuel-efficient sedan, perfect for city driving.',
        tag: 'Economy Sedan'
    },
    {
        id: 55,
        ...
        img: '/img55.png',
        badge: 'NEW',
        desc: 'Modern compact SUV with rugged styling and capable performance.',
        tag: 'Compact SUV'
    },
    {
        id: 56,
        ...
        img: '/img56.png',
        badge: 'UNIQUE',
        desc: 'Stylish and fun-to-drive wagon with unique barn doors.',
        tag: 'Wagon'
    },
];
...
// Newark (EWR) Airport - Affordable Car Rentals (img57 - img64)
const cars6 = [
    {
        id: 57,
        name: 'BMW X2',
        ...
        img: '/img57.png',
        badge: 'PREMIUM',
        desc: 'Sporty and stylish compact luxury SUV with premium driving experience.',
        tag: 'Luxury SUV'
    },
    {
        id: 58,
        ...
        img: '/img58.png',
        badge: 'POPULAR',
        desc: 'Versatile compact SUV with bold styling and capable features.',
        tag: 'Compact SUV'
    },
    {
        id: 59,
        ...
        img: '/img59.png',
        badge: 'NEW',
        desc: 'Modern and stylish midsize sedan with advanced technology.',
        tag: 'Midsize Sedan'
    },
    {
        id: 60,
        ...
        img: '/img60.png',
        badge: 'HYBRID',
        desc: 'Reliable and fuel-efficient hybrid sedan with excellent mileage.',
        tag: 'Hybrid Sedan'
    },
    {
        id: 61,
        ...
        img: '/img61.png',
        badge: 'PREMIUM',
        desc: 'Spacious and comfortable SUV with premium interior.',
        tag: 'Compact SUV'
    },
    {
        id: 62,
        ...
        img: '/img62.png',
        badge: 'BEST DEAL',
        desc: 'Highly reliable and fuel-efficient compact sedan.',
        tag: 'Economy Sedan'
    },
    {
        id: 63,
        ...
        img: '/img63.png',
        badge: 'RELIABLE',
        desc: 'Spacious, comfortable and highly reliable midsize sedan.',
        tag: 'Midsize Sedan'
    },
    {
        id: 64,
        ...
        img: '/img64.png',
        badge: 'ECONOMY',
        desc: 'Ultra fuel-efficient and affordable compact car for city driving.',
        tag: 'Compact Car'
    },
];


// 7. Newark Truck Rentals (img65 - img72)
const cars7 = [
    {
        id: 65,
        ...
        img: '/img65.png',
        badge: 'ELECTRIC',
        desc: 'Futuristic all-electric pickup with massive power and unique design.',
        tag: 'Electric Truck'
    },
    {
        id: 66,
        ...
        img: '/img66.png',
        badge: 'NEW',
        desc: 'Compact and efficient pickup truck perfect for city and light hauling.',
        tag: 'Compact Truck'
    },
    {
        id: 67,
        ...
        img: '/img67.png',
        badge: 'POPULAR',
        desc: 'High-performance electric truck with advanced features and capability.',
        tag: 'Electric Truck'
    },
    {
        id: 68,
        ...
        img: '/img68.png',
        badge: 'AFFORDABLE',
        desc: 'Classic full-size pickup with strong towing capacity and comfort.',
        tag: 'Full-Size Truck'
    },
    {
        id: 69,
        ...
        img: '/img69.png',
        badge: 'PREMIUM',
        desc: 'Top-spec Cybertruck with exceptional range and luxury interior.',
        tag: 'Electric Truck'
    },
    {
        id: 70,
        ...
        img: '/img70.png',
        badge: 'LUXURY',
        desc: 'Powerful electric pickup offering cutting-edge technology.',
        tag: 'Electric Truck'
    },
    {
        id: 71,
        ...
        img: '/img71.png',
        badge: 'PREMIUM',
        desc: 'Premium full-size truck with refined interior and strong performance.',
        tag: 'Full-Size Truck'
    },
    {
        id: 72,
        ...
        img: '/img72.png',
        badge: 'RELIABLE',
        desc: 'Durable and powerful full-size pickup trusted for work and daily use.',
        tag: 'Full-Size Truck'
    },
];

// 8. Toyota Rentals at Dallas (DFW) Airport (img73 - img80)
const cars8 = [
    {
        id: 73,
        name: 'Toyota Camry',
        ...
        img: '/img73.png',
        badge: 'BEST DEAL',
        desc: 'Reliable and comfortable midsize sedan with excellent fuel efficiency.',
        tag: 'Midsize Sedan'
    },
    {
        id: 74,
        ...
        img: '/img74.png',
        badge: 'POPULAR',
        desc: 'Smooth driving experience with modern features and spacious interior.',
        tag: 'Midsize Sedan'
    },
    {
        id: 75,
        ...
        img: '/img75.png',
        badge: 'AFFORDABLE',
        desc: 'Well-maintained classic Camry offering great value and reliability.',
        tag: 'Midsize Sedan'
    },
    {
        id: 76,
        ...
        img: '/img76.png',
        badge: 'TRUCK',
        desc: 'Rugged and capable midsize pickup truck perfect for work and adventure.',
        tag: 'Pickup Truck'
    },
    {
        id: 77,
        ...
        img: '/img77.png',
        badge: 'RELIABLE',
        desc: 'Modern Camry with advanced safety features and premium comfort.',
        tag: 'Midsize Sedan'
    },
    {
        id: 78,
        ...
        img: '/img78.png',
        badge: 'PREMIUM',
        desc: 'Spacious and fuel-efficient sedan with excellent condition.',
        tag: 'Midsize Sedan'
    },
    {
        id: 79,
        ...
        img: '/img79.png',
        badge: 'FAMILY',
        desc: 'Versatile and spacious hybrid minivan ideal for families and groups.',
        tag: 'Minivan'
    },
    {
        id: 80,
        ...
        img: '/img80.png',
        badge: 'NEW',
        desc: 'Brand new compact sedan with latest technology and safety features.',
        tag: 'Compact Sedan'
    },
];
...
// CarCard & ScrollSection components remain the same as before
function CarCard({ car }) {
    ...
    return (
        <div className="flex-shrink-0 w-[calc(25%-12px)] bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer group border border-gray-100 hover:-translate-y-2">
            {/* Image & other parts same as your previous design */}
            <div className="relative h-[175px] overflow-hidden rounded-t-2xl">
                ...
                <span className="absolute top-3 left-3 bg-blue-600 text-white text-[10px] font-black tracking-wider px-2.5 py-1 rounded-full shadow">{car.badge}</span>
                {/* Heart button, price badge etc. same */}
                <button onClick={e => { e.stopPropagation(); setLiked(p => !p); }} className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center shadow-md transition-all hover:scale-110">
                ...
                <div className="absolute bottom-3 right-3 w-[58px] h-[58px] rounded-full bg-black/70 backdrop-blur-sm flex flex-col items-center justify-center shadow-lg">
                    <span className="text-white text-[9px] font-semibold tracking-wide">ONLY</span>
                    <span className="text-white text-[16px] font-black">${car.price}</span>
                </div>
            </div>
            ...
            <div className="px-4 pt-3 pb-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button className="w-9 h-9 rounded-full bg-gray-100 hover:bg-[#593CFB] flex items-center justify-center transition-all group/btn shadow-sm">
                        <svg className="w-4 h-4 text-gray-600 group-hover/btn:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
...
export default function CarListings() {
    return (
        <>
            ...
            <ScrollSection
                title="Affordable car rental in San Francisco"
                subtitle="Average daily prices for a 3-day trip"
                items={cars5}
            />

            <ScrollSection
                title="Car rentals at Newark (EWR) airport"
                subtitle="Average daily prices for a 3-day trip"
                items={cars6}
            />

            <ScrollSection
                title="Truck rental in Newark"
                subtitle="Average daily prices for a 3-day trip"
                items={cars7}
            />

            <ScrollSection
                title="Toyota rental at Dallas (DFW) airport"
                subtitle="Average daily prices for a 3-day trip"
                items={cars8}
            />
        </>
